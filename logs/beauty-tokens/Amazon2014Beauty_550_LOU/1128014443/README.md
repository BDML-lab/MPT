...
|  CHECKPOINT_PATH  |   ./infos/beauty-tokens/Amazon2014Beauty_550_LOU/2    |
|  ckpt_epoch  |   4000    |
|  config  |   configs/finetune.yaml    |
|  dataset  |   Amazon2014Beauty_550_LOU    |
|  DATA_DIR  |   data    |
|  ddp_backend  |   nccl    |
|  description  |   beauty-tokens    |
|  device  |   cuda:2    |
|  dropout_rate  |   0.2    |
...
|  log2console  |   True    |
|  log2file  |   True    |
|  LOG_PATH  |   ./logs/beauty-tokens/Amazon2014Beauty_550_LOU/1128014443    |
|  lora_alpha  |   16    |
|  lora_dropout  |   0.1    |
|  lora_rank  |   8    |
|  lr  |   0.001    |
