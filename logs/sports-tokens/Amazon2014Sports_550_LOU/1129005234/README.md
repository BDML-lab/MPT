...
|  CHECKPOINT_PATH  |   ./infos/sports-tokens/Amazon2014Sports_550_LOU/2    |
|  ckpt_epoch  |   10    |
|  config  |   configs/finetune.yaml    |
|  dataset  |   Amazon2014Sports_550_LOU    |
|  DATA_DIR  |   data    |
|  ddp_backend  |   nccl    |
|  description  |   sports-tokens    |
|  device  |   cuda:2    |
|  dropout_rate  |   0.2    |
...
|  log2console  |   True    |
|  log2file  |   True    |
|  LOG_PATH  |   ./logs/sports-tokens/Amazon2014Sports_550_LOU/1129005234    |
|  lora_alpha  |   16    |
|  lora_dropout  |   0.1    |
|  lora_rank  |   8    |
|  lr  |   0.001    |
